...
const { sqlForPartialUpdate, sqlForJobsQuerySearch } = require('../helpers/sql');
...
class Job {
    ...
    static async create({ title, salary, equity, companyHandle }) {
        const result = await db.query(
           ...
           VALUES ($1, $2, $3, $4)
           RETURNING id, title, salary, equity, company_handle AS "companyHanlde"`, [title, salary, equity, companyHandle]
        );
    ...
    static async findAll(query = {}) {
        ...
        const { whereCols, values } = sqlForJobsQuerySearch(query);
